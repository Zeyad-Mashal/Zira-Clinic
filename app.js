...
const translations = {
    ...
    ar: {
        ...
        heroText: "اكتشف عيادة زيرا، حيث تلتقي رعاية الخبراء بالدفء. مكان مكرس لصياغة ابتسامات واثقة من خلال المتقدمة طب الأسنان. رحلتك إلى ابتسامة مشرقة تبدأ هنا، بالمزج التكنولوجيا مع الرحمة.",
